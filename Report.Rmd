...
The plot demonstrates a prevalence of forest fires during the dry seasons from June to November. Whether this trend is repetitive over the years is investigated by the following plot:
```{r}
fires_all %>%
