...
Now we build a new data set "fires_b" which contains the original cleaned data set, a month column, the moving average and centered moving average values as well as the :
```{r}
month <- NULL
for(i in 1:239){
  month[i] <- i%%12
